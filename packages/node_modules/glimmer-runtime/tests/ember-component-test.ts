...
QUnit.skip('components inside a list are destroyed', function(assert) {
  let destroyed = [];
  ...
  env.registerEmberishGlimmerComponent('destroy-me1', DestroyMe1Component as any, '<div>{{#destroy-me2 item=@item from="1"}}{{yield}}{{/destroy-me2}}</div>');
